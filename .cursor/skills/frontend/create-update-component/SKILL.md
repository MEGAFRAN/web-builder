...
description: >-
  Creates or updates React components with Storybook stories and component-affordances
  entries. Use when building or modifying components in components/, adding blocks,
  or updating the component catalog.
---
