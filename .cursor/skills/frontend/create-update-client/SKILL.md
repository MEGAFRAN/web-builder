...
description: >-
  Provisions new tenant client configs from templates under config/clients/.
  Use when creating, onboarding, or provisioning a new client site from
  config/templates/, or when asked to add config/clients/{clientId}.
---

# Create / Update Client

Use when asked to create, provision, or onboard a new tenant/client site from an existing template under `config/templates/`.
