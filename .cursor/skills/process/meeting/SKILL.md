...
7. **Create agent task files from the summary** — execute the `create-agent-task` skill (`.cursor/skills/ux/create-agent-task/SKILL.md`) in **engineering** mode using the step 6 summary as input. Task file format: `.cursor/skills/process/task-file-template.md`.
