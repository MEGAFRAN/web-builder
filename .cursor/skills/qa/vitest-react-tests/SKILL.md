---
name: vitest-react-tests
description: >-
  Creates, updates, and debugs Vitest tests for Next.js components, hooks, lib,
  and app/api route handlers. Use when adding React tests, fixing act(...) warnings,
  debounce test timeouts, or debugging npm run test failures.
---
