...
description: >-
  Creates new business templates under config/templates/ via a structured discovery
  interview. Use when creating a new template for a business vertical, designing
  homepage block sequences, or provisioning template.json and pages.
---
