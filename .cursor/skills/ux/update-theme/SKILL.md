...
name: update-theme
description: >-
  Recommends theme token or preset changes with design and accessibility rationale.
  Use when theme changes, color palette updates, or visual rhythm adjustments
  are requested.
---
