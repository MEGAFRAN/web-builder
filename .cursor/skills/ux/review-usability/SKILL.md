...
description: >-
  Reviews components and pages for usability with prioritized findings by user impact.
  Use when usability review, UX critique, or interaction design feedback is needed
