---
name: select-component-pattern
description: >-
  Recommends registry components and UX patterns for stated user goals. Use when
  choosing component patterns, matching user goals to CMS blocks or primitives,
  or identifying component gaps.
---
