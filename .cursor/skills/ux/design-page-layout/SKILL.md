...
description: >-
  Designs page structure with component maps, visual hierarchy, and grid layout rules.
  Use when laying out landing pages, dashboards, pricing pages, or new page sections.
---
