...
export const adminCopy = {
  ...
  companyProfile: {
    ...
    intro:
      'Los datos de tu negocio se utilizan en el pie de página, la cabecera, los metadatos del sitio y los bloques de contacto.',
    form: {
      ...
      deployNote: 'Los cambios se reflejarán en el sitio público tras el siguiente despliegue.',
    },
  },
  bookings: {
    heading: 'Reservas',
