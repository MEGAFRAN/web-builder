  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-white shadow-[0_-4px_24px_rgba(0,0,0,0.06)] [will-change:transform] [transform:translateZ(0)]"
      >
        <div
