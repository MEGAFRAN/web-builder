...
description: >-
  ...
  Chains /meeting with /implement-tasks. Usage: /plan-and-implement
---
...
1. Read and execute `.claude/skills/strategy/meeting.md` in full
2. Run the multi-agent meeting sequentially via the **Agent** tool
...
1. Read and execute `.claude/skills/process/implement_tasks.md`
...
- Meeting skill: `.claude/skills/strategy/meeting.md`
- Implement skill: `.claude/skills/process/implement_tasks.md`
- Task template: `.claude/skills/process/task_file_template.md`
