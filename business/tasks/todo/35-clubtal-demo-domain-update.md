...
5. Document `https://moviles.clubtal.com` as the canonical outreach URL in `docs/infrastructure/demo-swa.md`.
...
- Automating Azure custom-domain DNS in deploy workflow (manual for M0).
- Local deploy script (`deploy:demo`) — CI is canonical.
